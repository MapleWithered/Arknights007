...
def reco_skills(debug_show=False):
    ...
    time1 = time.time()
    img_template = cv2.imread("resources/game_data/ship_skill/icon/Bskill_ctrl_cost.png", cv2.IMREAD_COLOR)
    img_mask = cv2.imread("resources/game_data/ship_skill/mask/Bskill_ctrl_cost.png", cv2.IMREAD_COLOR)
