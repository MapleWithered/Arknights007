...
import arknights007.ship_skill as ship_skill
...
def room_number_to_category(room_number: typing.Optional[str] = None) -> int:
    ...
    room_category_dict: dict[str, int] = res.load_yaml("config/ship_manufactory_room.yaml")
...
def handle_drone():
    ...
    path_handle_drone = res.get_img_path('/common_record/'+drone_config['drone_record_name']+'.yaml')
