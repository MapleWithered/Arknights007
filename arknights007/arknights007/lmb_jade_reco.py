...
def reco_all():
    ...
    img_template_r1 = res.get_img_bgr("/public_recruit/R1.png")
    img_template_r2 = res.get_img_bgr("/public_recruit/R2.png")
    img_template_r3 = res.get_img_bgr("/public_recruit/R3.png")
    img_template_r4 = res.get_img_bgr("/public_recruit/R4.png")
